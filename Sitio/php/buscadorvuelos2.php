<html>
	...
	<body>
		...
		<div id="div_realizar_reserva">
			...
			<h3 class="title_h3_res">Datos del Vuelo de Vuelta</h3>	
			...
			<form>	
					...
					echo '	<label class="label_text_res_3" for="hora"> Hora: </label>
								<select class="input_combo_res" id="cmb_hora_vuelo" name="hora">';
									...
									$filas = $db -> exec_Select (
																				...
																				'where ao.codigo_OACI = "' . $origenV . '" ' .
																				'and ad.codigo_OACI = "' . $destinoV . '" ' .
																				'and v.' . $dia_regreso . ' = 1 '.
				...
				<div id="div_botones_res">
					...
					<input type="button" class="input_button_res_1" id="btn_cod_reservar" name="btn_cod_reservar" value="Comenzar Reserva" onclick="valida_reserva2('<?php echo $codvuelo?>','<?php echo $origen?>','<?php echo $corigen?>','<?php echo $destino?>','<?php echo $cdestino?>','<?php echo $precio?>','<?php echo $fsalida?>','<?php echo $codvueloV?>','<?php echo $origenV?>','<?php echo $corigenV?>','<?php echo $destinoV?>','<?php echo $cdestinoV?>','<?php echo $precioV?>','<?php echo $fregreso?>','<?php echo $clase?>','<?php echo $dia_salida?>','<?php echo $dia_regreso?>','<?php echo $ida_vuelta?>','<?php echo $hora_ida?>','<?php echo $check_lista_espera?>')"/> 
				</div>
			</form>
		</div>
	</body>	
